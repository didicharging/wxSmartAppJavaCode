...
//	public Map<String, Object> getDeviceState(@RequestParam(required = true) String deviceNo,
...
//		EWalletLogExample.Criteria walletLogcriteria = walletLogExample.createCriteria();
...
//			}
//
//			if (wallet.getShareAmount().compareTo(new BigDecimal(totalShareMoney)) == -1) {
...
//
//		if (functionList.length == 1 && functionList[0].equals(EScaneLog.RECIVE_DEVICE.toString())) {
//			// 调用领取逻辑
...
//	}
	...
	public Map<String, Object> ReciveDevice(@RequestParam(required = true) String deviceId,
		...
		if(flag) device.setState(EDevice.ELECTRIC_LESS);
...
//				}
	...
	public Map<String, Object> chargeDevice(@RequestParam(required = true) String deviceId,
			@RequestParam(required = true) String adaptCode,
			@RequestParam(required = true) String userId) {
		Map<String, Object> res = new HashMap<String, Object>();
