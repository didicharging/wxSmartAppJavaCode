...
public class FansController {
	...
	@ResponseBody
	public Map<String, Object> getFansList(@RequestParam(defaultValue = "1") int page,
	...
	@ResponseBody
	public Map<String, Object> getFollowList(@RequestParam(defaultValue = "1") int page,
			@RequestParam(defaultValue = "10") int perPage, @RequestParam(required = true) String userId) {
		Map<String, Object> res = new HashMap<String, Object>();
		try {
			EFans fans = new EFans();
	...
	@ResponseBody
	public Map<String, Object> delFans(@RequestParam(required = true) String userId,
		...
		try {
			...
			List<EFans> fansList = (List<EFans>) fansService.list(fans, 1, 10).get("data");
	...
	@ResponseBody
	public Map<String, Object> delFollow(@RequestParam(required = true) String userId,
	...
	@ResponseBody
	public Map<String, Object> follow(@RequestParam(required = true) String userId,
			@RequestParam(required = true) String followUserId) {
		Map<String, Object> res = new HashMap<String, Object>();
		try {
			EFans fans = new EFans();
